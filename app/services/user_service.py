...
from app.schemas import UserUpdate, SellerProfileCreate, SellerProfileUpdate, UserCreate
...
class UserService:
    ...
    def update_user(self, db: Session, user_id: str, user_update: UserUpdate):
        """ユーザー情報を更新"""
    ...
    def update_seller_profile(self, db: Session, user_id: str, profile_update: SellerProfileUpdate):
        """販売者プロフィールを更新"""
    ...
    def create_seller_profile(self, db: Session, user_id: str, profile_create: SellerProfileCreate):
        """販売者プロフィールを作成"""
