...
class UserCRUD(BaseCRUD[User, UserCreate, UserUpdate]):
    ...
    def create_seller_profile(self, db: Session, *, user_id: str, obj_in: SellerProfileCreate):
    ...
    def update_seller_profile(self, db: Session, *, db_obj: SellerProfile, obj_in: SellerProfileUpdate):
        update_data = obj_in.dict(exclude_unset=True)
        for field, value in update_data.items():
            setattr(db_obj, field, value)
        db.add(db_obj)
