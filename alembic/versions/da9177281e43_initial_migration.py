...
Revises: 
Create Date: 2024-12-11 22:24:46.323667
...
def upgrade() -> None:
    ...
    sa.Column('company_type', sa.Enum('MANUFACTURER', 'DESIGN', 'CONSTRUCTION', name='companytype'), nullable=False),
    ...
    sa.Column('role', sa.Enum('BUYER', 'SELLER', 'BOTH', name='userrole'), nullable=False),
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('property_type', sa.Enum('house', 'apartment', 'other', name='propertytype'), nullable=False),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('image_type', sa.Enum('main', 'sub', name='imagetype'), nullable=False),
    ...
    sa.Column('sale_type', sa.Enum('PROPERTY', 'ROOM', 'PRODUCT', 'CONSULTATION', name='saletype'), nullable=False),
    sa.Column('consultation_type', sa.String(), nullable=True),
    sa.Column('status', sa.Enum('DRAFT', 'PUBLISHED', 'SOLD', name='salestatus'), nullable=True),
    sa.Column('property_id', sa.Integer(), nullable=True),
    sa.Column('room_id', sa.Integer(), nullable=True),
    sa.Column('product_id', sa.Integer(), nullable=True),
